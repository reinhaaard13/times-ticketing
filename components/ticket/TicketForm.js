					...
					<Flex flexDirection="column">
						<Flex flexDir={["column", "row"]}>
							...
							<FormControl
								...
								isRequired
								isInvalid={
									formik.errors.subproduct && formik.touched.subproduct
								}
							>
									...
									{products
										...
										?.Subproducts.find(
											(subproduct) =>
												...
												parseInt(formik.values.subproduct)
										)
										?.CaseSubjects.map((casesubject, idx) => (
											<option key={idx} value={casesubject.id}>
												{casesubject.subject}
											</option>
										))}
								</Select>
						...
						<Flex flexDir={["column", "row"]}>
							...
							<FormControl
								...
								isRequired
								isInvalid={
									formik.errors.cust_email && formik.touched.cust_email
								}
							>
						...
						>
							<FormLabel htmlFor="assigned_to">Assign To Department</FormLabel>
							<Select
								id="assigned_to"
								name="assigned_to"
